package top.webdbw.tallybook.anim;
...
/**
 * 主页RecyclerView自定义item动画，参考{@link androidx.recyclerview.widget.DefaultItemAnimator}来进行的实现
 */
public class MainRecyclerViewAnimator extends SimpleItemAnimator {
